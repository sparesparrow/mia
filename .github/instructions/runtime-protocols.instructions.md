...
- When changing MQTT or event naming, update `spec/interfaces/topics.md`, `spec/interfaces/events.md`, and every publisher or subscriber in the same change. Topic drift is a runtime bug, not a docs-only issue.
...
- Related docs: [spec/interfaces/topics.md](../../spec/interfaces/topics.md), [spec/interfaces/events.md](../../spec/interfaces/events.md), [spec/architecture/README.md](../../spec/architecture/README.md), [README.md](../../README.md), and [../copilot-instructions.md](../copilot-instructions.md).