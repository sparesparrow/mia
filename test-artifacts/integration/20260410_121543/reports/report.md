...
| pi.service.zmq-broker | fail | activating |
| pi.service.mia-api | fail | activating |
| pi.service.mia-gpio-worker | fail | activating |
| pi.service.mia-serial-bridge | fail | inactive |
| pi.service.mia-obd-worker | fail | inactive |
| pi.service.mia-ble-advertiser | fail | inactive |
| pi.service.mia-ble-obd | fail | inactive |
| pi.api.status | fail | Pi /status unavailable |
...
- Confirm the Pi API listens on port 8000 and that the phone-facing host resolves to the same 192.168.200.x address.
