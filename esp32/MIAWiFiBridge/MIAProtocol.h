#ifndef MIA_PROTOCOL_ESP32_H
#define MIA_PROTOCOL_ESP32_H

#include <Arduino.h>

// Protocol constants (matching Arduino version)
...
class MIAProtocolESP32 {
public:
    MIAProtocolESP32(HardwareSerial* serial = &Serial, uint32_t baudRate = 115200);
