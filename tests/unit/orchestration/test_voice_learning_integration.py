...
# voice-learning is not an importable package name; its modules import each other flat.
_VOICE_DIR = os.path.join(
    os.path.dirname(__file__), "..", "..", "..", "orchestration", "mcp", "modules", "voice-learning"
)
...
from mcp_tools import VoiceLearningToolRegistry  # noqa: E402
from validation import validate_and_parse_json  # noqa: E402
...
class TestDTOInstantiation:
    ...
    def test_failure_output_with_enum(self):
        ...
        from dtos import FailureClassification
