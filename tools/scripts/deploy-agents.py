...
Usage:
    python tools/scripts/deploy-agents.py              # Deploy all agents
    python tools/scripts/deploy-agents.py --dry-run    # Print payloads without calling API
    python tools/scripts/deploy-agents.py --agent executor  # Deploy one agent only
"""
