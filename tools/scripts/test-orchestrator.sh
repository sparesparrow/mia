...
SKILL_DIR="$PROJECT_ROOT/.claude/skills/android-adb-test"
...
Examples:
  ./tools/scripts/test-orchestrator.sh HT36TW903516
  ./tools/scripts/test-orchestrator.sh emulator-5554 full-flow 1
EOF
}
