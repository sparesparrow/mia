...
#
# Usage:
#   sudo ./tools/scripts/deploy-complete-system.sh          # Full deployment
#   sudo ./tools/scripts/deploy-complete-system.sh --phase system  # System setup only
#   sudo ./tools/scripts/deploy-complete-system.sh --phase validate # Validation only
#   sudo ./tools/scripts/deploy-complete-system.sh --help   # Show help
#
# =============================================================================
...
phase_repository() {
    ...
    if [[ -f "apps/rpi-backend/py-api/api/main.py" ]] && [[ -f "infra/systemd/mia-api.service" ]] && [[ -f "apps/rpi-backend/config/paths.json" ]]; then
...
phase_services() {
    ...
    if [[ -d "$PROJECT_ROOT/scripts" ]]; then
        run_cmd "cp -r '$PROJECT_ROOT/tools/scripts/.' '$INSTALL_DIR/scripts/'" "Copying operational scripts"
    fi

    run_cmd "cp -r '$PROJECT_ROOT/apps/rpi-backend/config/.' '$INSTALL_DIR/config/'" "Copying MIA configuration"
